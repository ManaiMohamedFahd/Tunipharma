 ...
 */
public class MyTableModelTypePharmacie extends AbstractTableModel {
public static String okok="";
    ...
    public MyTableModelTypePharmacie() { //remplissage de la liste des stocks
        Pharmacies=new PharmacieDAO().findPharmacieByType(okok);
