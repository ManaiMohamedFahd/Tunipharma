 ...
 */
public class MyTableModelPharmacieFind extends AbstractTableModel {
public static String ok="";
    ...
    public MyTableModelPharmacieFind() { //remplissage de la liste des stocks
        Pharmacies=new PharmacieDAO().findPharmacieByGouvernements(ok);
