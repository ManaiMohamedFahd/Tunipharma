 ...
 * @author azerty
 */
public class MyTableModelTypeMdc extends AbstractTableModel{
    ...
    public MyTableModelTypeMdc() { //remplissage de la liste des stocks
        medicaments=new MedicamentDAO().findMedicamentByType(kk);
    }
